...
if (stockCount >= 1) {
  console.log("I'm going to eat some Chicken salad!");
} else {
  console.log("We need to get some more Chicken salad.");
}
...
var vegetables = ["Tomato", "Carrot", "Broccoli", "Celery", "Onion"];
...
var fruits = ["Apple", "Banana", "Orange", "Grapefruit", "Pear"];
...
// It would make sense to add keys like address, phoneNumber, and isBusy
var groceryStore = {
  name: "King Soopers",
  isOpen: true,
  }
